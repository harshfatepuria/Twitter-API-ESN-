...
<div id="header">
	<div id="logo">
		<h1><a href="index.php"><span>Twitter Network</span></a></h1>
	...
	<div id="menu">
		<ul id="main">
			...
			<li class="current_page_item"><a>About</a></li>
		</ul>
	</div>
</div>
<!-- end header -->
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title">Hi! This application is created by me to use the Twitter v1.1 REST API along with PHP and MySQL.</h1>
				<p class="byline"></p>
				<div class="entry">
